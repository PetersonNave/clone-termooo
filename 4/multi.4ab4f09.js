...
const myParam = urlParams.get("t1");
const myParam2 = urlParams.get("t2");
const myParam3 = urlParams.get("t3");
const myParam4 = urlParams.get("t4");

var paramRow = [myParam, myParam2, myParam3, myParam4];
...
function t(a, e, o) {
  return (
    e && i(a.prototype, e),
    o && i(a, o),
    Object.defineProperty(a, "prototype", { writable: 0 }),
    a
  );
}
function n(a, e, o) {
...
function s(a, e) {
  ...
  (a.prototype = Object.create(e && e.prototype, {
    constructor: { value: a, writable: 1, configurable: 1 },
  })),
    Object.defineProperty(a, "prototype", { writable: 0 }),
    e && c(a, e);
}
...
function f(a, e) {
  return (
    e || (e = a.slice(0)),
    Object.freeze(
      Object.defineProperties(a, { raw: { value: Object.freeze(e) } })
    )
  );
}
function b(a, e) {
  ...
  if (!o) {
    if (
      ...
      return {
        s: i,
        n: function () {
          return r >= a.length ? { done: 1 } : { done: 0, value: a[r++] };
        },
        e: function (a) {
          throw a;
        },
    ...
    return (
      ...
      (M.prototype = {
        ...
        delegateYield: function (a, o, r) {
          return (
            (this.delegate = { iterator: z(a), resultName: o, nextLoc: r }),
...
var Ma = q,
  ...
  ae = function (a, e) {
    try {
      $a(_a, a, { value: e, configurable: 1, writable: 1 });
    } catch (o) {
      _a[a] = e;
    }
    return e;
...
ot(
  { target: "Array", proto: 1, forced: !pt || !ft },
  {
    concat: function (a) {
      var e,
        o,
...
var vt = Ii,
  ...
  Bt = bo.exports,
  yt = ht;
wt || Bt(Object.prototype, "toString", yt, { unsafe: 1 });
var Et = Tr,
  Qt = Sr,
  Dt =
    Object.keys ||
...
var Mt = qa,
  ...
  Rt = Ut.map;
di(
  { target: "Array", proto: 1, forced: !et("map") },
  {
    map: function (a) {
...
var Yt = k,
  ...
  Kt = Jt("join", ",");
Gt(
  { target: "Array", proto: 1, forced: Wt || !Kt },
  {
    join: function (a) {
...
var Xt = Ut.filter;
di(
  { target: "Array", proto: 1, forced: !et("filter") },
  {
    filter: function (a) {
...
var Zt = Ii,
  ...
  un = { BROKEN_CARET: sn, MISSED_STICKY: nn, UNSUPPORTED_Y: tn },
  cn = {},
  ln = F,
  mn = $e,
  An = _e,
...
var is = Xn;
di({ target: "RegExp", proto: 1, forced: /./.exec !== is }, { exec: is });
var ts = O,
      ...
      var s = ls(/./[i]),
        u = e(i, ""[a], function (a, e, o, r, i) {
          ...
          return u === As || u === bs.exec
            ? t && !i
              ? { done: 1, value: s(e, o, r) }
              : { done: 1, value: n(o, e, r) }
            : { done: 0 };
        });
...
var yu = ca,
  ...
  zu = { start: Mu(1), end: Mu(2), trim: Mu(3) },
  Iu = C,
  Cu = k,
  Nu = Z,
  ku = $t,
  ...
  Ru =
    ...
    (Su &&
      ...
      : Ou;
di(
  { target: "Number", stat: 1, forced: Number.parseInt != Ru },
  { parseInt: Ru }
);
var Yu = C,
  Pu = ga,
...
var xc = (function () {
  ...
  Lc = function (a, e, o) {
    a && !o && (a = a.prototype),
      a && !Tc(a, Sc) && Oc(a, Sc, { configurable: 1, value: e });
  },
  Uc = ha,
  Rc = _e,
  Yc = F,
...
Sm ||
  ...
  Mm || Cm || Im || !Nm || !km
    ...
    : ((fm = 1),
      ...
      new Nm(Am).observe(bm, { characterData: 1 }),
      (pm = function () {
        bm.data = fm = !fm;
      })));
var Lm =
...
if (
  ...
  (Xm = NA.then),
    PA ||
      ...
      iA(NA, "catch", FA.catch, { unsafe: 1 }));
  try {
    delete NA.constructor;
  } catch (a) {}
  nA && nA(NA, FA);
}
$m({ global: 1, wrap: 1, forced: GA }, { Promise: kA }),
  sA(kA, MA, 0),
  uA(MA),
  (Km = eA(MA)),
  $m(
    { target: MA, stat: 1, forced: GA },
    {
      reject: function (a) {
        var e = LA(this);
              ...
              return (
                (t =
                  null !==
                    ...
                    : window.opera),
                (a.next = 3),
                wg({ type: "error", ua: t, msg: e, stack: o, game: hg })
              );
            case 3:
            case "end":
              return a.stop();
...
var Qg = Cn,
  ...
  xg = De("unscopables"),
  jg = Array.prototype;
null == jg[xg] && Dg.f(jg, xg, { configurable: 1, value: Qg(null) });
var Mg,
  zg,
  Ig,
  Cg = function (a) {
...
var Kg = { IteratorPrototype: Mg, BUGGY_SAFARI_ITERATORS: Vg },
  ...
  vd = function (a, e, o, r, i, t, n) {
    !(function (a, e, o) {
      var r = e + " Iterator";
      (a.prototype = Zg(Xg, { next: _g(1, o) })), $g(a, r, 0), (ad[r] = ed);
    })(o, e, r);
    var s,
      u,
      c,
    ...
    if (
      ...
      else od({ target: e, proto: 1, forced: pd || A }, u);
    return g[fd] !== p && ld(g, fd, p, { name: i }), (md[e] = p), u;
  },
  hd = Aa,
  wd = Cg,
  Bd = Vc,
  ...
  Md = Qd(
    ...
    "Array",
    function (a, e) {
      xd(this, { type: "Array Iterator", target: hd(a), index: 0, kind: e });
    },
    function () {
      var a = jd(this),
        e = a.target,
        ...
        r = a.index++;
      return !e || r >= e.length
        ? ((a.target = void 0), { value: void 0, done: 1 })
        : "keys" == o
        ? { value: r, done: 0 }
        : "values" == o
        ? { value: e[r], done: 0 }
...
var Sd = k(function () {
  ...
  rp = 0,
  ip = function (a) {
    Xd(a, op, { value: { objectID: "O" + rp++, weakData: {} } });
  },
  tp = (Id.exports = {
    enable: function () {
    ...
    if (
      ...
      d ||
        (((u = e(function (a, e) {
          gp(a, s);
          var o = hp(new n(), a, u);
          return null != e && Ap(e, o[t], { that: o, AS_ENTRIES: r }), o;
        })).prototype = s),
        (s.constructor = u)),
  ...
  kp = {
    getConstructor: function (a, e, o, r) {
      var i = a(function (a, i) {
          Dp(a, t),
            ...
            zp || (a.size = 0),
            null != i && xp(i, a[r], { that: a, AS_ENTRIES: o });
        }),
        t = i.prototype,
        n = Np(e),
        s = function (a, e, o) {
    ...
    setStrong: function (a, e, o) {
      ...
      jp(
        ...
        e,
        function (a, e) {
          Cp(this, { type: r, target: a, state: i(a), kind: e, last: void 0 });
        },
        function () {
          ...
          return a.target && (a.last = o = o ? o.next : a.state.first)
            ? "keys" == e
              ? { value: o.key, done: 0 }
              : "values" == e
              ? { value: o.value, done: 0 }
              : { value: [o.key, o.value], done: 0 }
            : ((a.target = void 0), { value: void 0, done: 1 });
        },
        o ? "entries" : "values",
        !o,
...
Sp(
  ...
  "String",
  function (a) {
    Lp(this, { type: "String Iterator", string: Op(a), index: 0 });
  },
  function () {
    var a,
      e = Up(this),
    ...
    return r >= o.length
      ? { value: void 0, done: 1 }
      : ((a = Fp(o, r)), (e.index += a.length), { value: a, done: 0 });
  }
);
var Rp = {
    CSSRuleList: 0,
...
var hf = {
  getConstructor: function (a, e, o, r) {
    var i = a(function (a, i) {
        sf(a, t),
          lf(a, { type: e, id: pf++, frozen: void 0 }),
          null != i && uf(i, a[r], { that: a, AS_ENTRIES: o });
      }),
      t = i.prototype,
      n = mf(e),
      s = function (a, e, o) {
...
var Hf = new WeakMap(),
  ...
  Vf = (function () {
    ...
    function e() {
      ...
      return (
        r(this, e),
        j(g((o = a.call(this))), Hf, { writable: 1, value: null }),
        j(g(o), Jf, { writable: 1, value: 0 }),
...
var ab,
  ...
  ib = { startTime: 0, endTime: 0, highContrastChange: 0 },
  tb = { highContrast: 0, hardMode: 0 },
  nb = new Set([
    "space",
    "enter",
    "backspace",
...
function lb(a) {
  this.dispatchEvent(new CustomEvent("kbd", { detail: { key: a } }));
}
          ...
          try {
            var t = function () {
              ...
              e.addEventListener("change", function () {
                a.dispatchEvent(
                  new CustomEvent("update", { detail: { id: e.id } })
                );
              });
            };
...
var kb = fr,
  ...
  Hb = { start: qb(0), end: qb(1) },
  Jb = /Version\/10(?:\.\d+){1,2}(?: [\w./]+)?(?: Mobile\/\w+)? Safari\//.test(
    Ba
  ),
  Vb = Hb.start;
di(
  { target: "String", proto: 1, forced: Jb },
  {
    padStart: function (a) {
...
var ov = Z,
  ...
  Av = ov(cv),
  gv = uv(function () {
    return "/a/b" != mv.call({ source: "a", flags: "b" });
  }),
...
lh(
  { target: "Array", proto: 1, forced: !Bh },
  {
    slice: function (a, e) {
      var o,
        r,
...
function aw(a, e, o, r) {
  return { x: a, y: e, width: o, height: r };
}
var ew = (function () {
    function a(a) {
  ...
  ow = function (a, e) {
    ...
    Wh(this, { target: a, contentRect: o });
  },
  rw = (function () {
    function a(a, e, o) {
      if (
...
var nw,
  ...
  lw = { right: "correta", place: "em outro local", wrong: "errada" },
  mw = (function () {
    s(n, Vf);
    var a,
      e,
  ...
  return (
    t(e, [
      ...
      },
      {
        key: "html",
        value: function () {
          return '\n  <div id=left>\n<a id="termo" href=\'/?termo=1\'>termo</a>\n<a id="duo" href=\'/2/?t1=1&t2=1\'>dueto</a>\n<a id="quatro" href=\'/4/?t1=1&t2=1&t3=1&t4=1\'>quarteto</a>\n</div>\n<div id="right">\n<a id="about" href=\'\'><img src=\''.concat(
...
var Qw = C,
  Dw = Lc;
di({ global: 1 }, { Reflect: {} }), Dw(Qw.Reflect, "Reflect", 1);
var xw = new Proxy(
  {},
  {
    get: function (a, e) {
...
function Iw() {
  xw.modal
    .getModal("config")
    .setConfig({ highContrast: tb.highContrast, hardMode: tb.hardMode }),
...
if (Kw) {
  ...
  (vB = (bB = function (a) {
    aB(this, vB);
    var e = rB(a);
    pB(this, { bytes: QB(yB(e), 0), byteLength: e }),
    ...
    (wB = (hB = function (a, e, o) {
      ...
      pB(this, { buffer: a, byteLength: o, byteOffset: i }),
...
var GB = { ArrayBuffer: bB, DataView: hB },
  qB = di,
  HB = Z,
  JB = k,
  VB = io,
...
var ry = Gc,
  iy = GB.ArrayBuffer;
di({ global: 1, forced: C.ArrayBuffer !== iy }, { ArrayBuffer: iy }),
  ry("ArrayBuffer");
for (
  var ty = window.atob(
...
"findIndex" in [] &&
  ...
  wy(
    { target: "Array", proto: 1, forced: Ey },
    {
...
var Qy = di,
  ...
  Oy = Math.min;
Qy(
  { target: "Array", proto: 1, forced: !Ny },
  {
    splice: function (a, e) {
      var o,
        r,
          ...
          value: function () {
            ...
            if (
              ...
              return (
                ...
                this.event("commitError", { msg: "essa palavra não é aceita" })
              );
            if (
              (tb.hardMode
...
var Vy = Cg;
di({ target: "Array", proto: 1 }, { fill: Hw }), Vy("fill");
var Wy,
  Ky,
  Xy = di,
  Zy = C,
  ...
  iE = $y(/./.test);
Xy(
  { target: "RegExp", proto: 1, forced: !oE },
  {
    test: function (a) {
      var e = this.exec;
...
var sE = C,
  ...
  BQ = function (a, e) {
    var o = (dQ[a] = kE(tQ));
    return (
      eQ(o, { type: "Symbol", tag: a, description: e }),
      vE || (o.description = e),
      o
    );
  },
...
if (
  (hE ||
    (GE(
      (tQ = (iQ = function () {
        ...
        return vE && hQ && wQ(rQ, e, { configurable: 1, set: o }), BQ(e, a);
      }).prototype),
      "toString",
      function () {
        return oQ(this).tag;
    ...
    vE &&
      ...
      GE(rQ, "propertyIsEnumerable", QQ, { unsafe: 1 }))),
  AE({ global: 1, wrap: 1, forced: !hE, sham: !hE }, { Symbol: iQ }),
  _E(FE(vQ), function (a) {
    KE(a);
  }),
  AE(
    { target: "Symbol", stat: 1, forced: !hE },
    {
      for: function (a) {
        var e = CE(a);
  ...
  AE(
    { target: "Object", stat: 1, forced: !hE, sham: !vE },
    {
      create: function (a, e) {
  ...
  AE(
    { target: "Object", stat: 1, forced: !hE },
    { getOwnPropertyNames: xQ, getOwnPropertySymbols: jQ }
  ),
  AE(
    {
      target: "Object",
...
if (IQ && FQ(UQ) && (!("description" in RQ) || void 0 !== UQ().description)) {
  ...
  SQ(RQ, "description", {
    ...
    zQ({ global: 1, forced: 1 }, { Symbol: PQ });
}
mE("iterator");
var KQ = $t,
  XQ = pa,
  ...
  bD = function (a, e, o, r) {
    ...
    if (s) {
      ...
      (l.prototype = u),
        "Error" !== n && (uD ? uD(l, c) : cD(l, c, { name: 1 })),
        cD(l, s);
      try {
  ...
  vD = C.WebAssembly,
  hD = 7 !== Error("e", { cause: 7 }).cause,
  wD = function (a, e) {
    var o = {};
    (o[a] = bD(a, e, hD)), pD({ global: 1, forced: hD }, o);
  },
  BD = function (a, e) {
    if (vD && vD[a]) {
      var o = {};
      (o[a] = bD("WebAssembly." + a, e, hD)),
        pD({ target: "WebAssembly", stat: 1, forced: hD }, o);
    }
  };
function yD(a, e, o, r) {
  ...
  function s(t) {
    return function (s) {
      return (function (t) {
          ...
          try {
            ...
            switch (((r = 0), i && (t = [2 & t[0], i.value]), t[0])) {
              ...
              case 1:
                ...
                break;
              case 4:
                return n.label++, { value: t[1], done: 0 };
              case 5:
                n.label++, (r = t[1]), (t = [0]);
                continue;
              case 7:
        ...
        if (5 & t[0]) throw t[1];
        return { value: t[0] ? t[1] : void 0, done: 1 };
      })([t, s]);
    };
  }
}
    ...
    return ED(this, function () {
      ...
      return SD(a) ||
        ...
        (function (a) {
          ...
          e.setAttribute("style", "-webkit-user-select: text !important");
          var o = e;
          e.attachShadow && (o = e.attachShadow({ mode: "open" }));
              ...
              case 0:
                if (
                  ...
                  !(
                    ...
                    navigator.share &&
                    navigator.canShare &&
                    navigator.canShare({ text: e })
                  ))
                ) {
                  a.next = 11;
                  break;
                }
                return (a.prev = 2), (a.next = 5), navigator.share({ text: e });
              case 5:
                return Mw("compartilhado"), a.abrupt("return");
              case 9:
                (a.prev = 9), (a.t0 = a.catch(2));
...
var ux = { right: "#3AA394", place: "#D3AD69", wrong: "#312A2C" };
function cx(a) {
          ...
          Qx(
            ...
            Qx(
              Dx({}, "a", {
                enumerable: 1,
                get: function () {
                  Dx(this, "b", { value: 3, enumerable: 0 });
                },
              }),
              { b: 2 }
            )
...
di({ target: "Object", stat: 1, forced: Object.assign !== Mx }, { assign: Mx });
var Ix = [
  "curday",
  "solution",
  "normSolution",
...
function Cx(a) {
  ...
  })(Mc, { config: tb, meta: ib, stats: rb, state: o });
}
(hg = Mc),
    ...
    py() !== a[0].curday &&
      (function (a) {
        for (
          ...
          var n = a[t];
          (n.solution = 1 == xc ? o[r] : Zf[paramRow[t]]),
